...
if ($barang_id) {
    $querybarang = mysqli_query($conn, "SELECT * FROM barang WHERE barang_id='$barang_id'");
    ...
    $gambar = "<img style='width: 200px; vertical-align: middle;' src='".BASE_URL."images/barang/$gambar'>";
}
?>
...
<form action="<?php echo BASE_URL . "module/barang/action.php?barang_id=$barang_id"; ?>" method="post" enctype="multipart/form-data">
    ...
    <div style="margin-bottom: 15px">
        <label style="font-weight: bold" for="">Deskripsi</label>
        <span><textarea id="editor" type="text" name="spesifikasi"><?php echo $spesifikasi; ?></textarea></span>
    </div>
    <div class="element-form">
    ...
    <div class="element-form">
        ...
        <span><input type="file" name="file" value=''><?php echo $gambar; ?></span>
    </div>
    <div class="element-form">
